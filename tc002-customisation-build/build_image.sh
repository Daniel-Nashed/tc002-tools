...
# automatically by build.sh/start_panel.sh the first time the image does
# not exist yet - run directly only if you want to force a rebuild (e.g.
# after bumping ZIG_VERSION in common.sh).
set -euo pipefail
